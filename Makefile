#
# OMNeT++/OMNEST Makefile for veins_manhattan
#
# This file was generated with the command:
#  opp_makemake -f --deep -O out -KINET_PROJ=../inet -KVEINS_PROJ=../veins-veins-4.7.1 -DINET_IMPORT -I. -I$$\(INET_PROJ\)/src -I$$\(VEINS_PROJ\)/src -Isrc -L$$\(INET_PROJ\)/src -L$$\(VEINS_PROJ\)/src -lINET$$\(D\) -lveins$$\(D\)
#

# Name of target to be created (-o option)
TARGET = veins_manhattan$(D)$(EXE_SUFFIX)
TARGET_DIR = .
...
%_m.cpp %_m.h: %.msg
	$(qecho) MSGC: $<
	$(Q)$(MSGC) -s _m.cpp -MD -MP -MF $O/$(basename $@).d $(MSGCOPTS) $?
